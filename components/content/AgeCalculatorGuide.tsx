import { BookOpen, Calendar, ShieldCheck, CheckCircle2 } from 'lucide-react';

export default function AgeCalculatorGuide() {
  return (
    <article className="w-full max-w-4xl mx-auto space-y-12 py-8 text-slate-200">
      {/* Introduction */}
      ...
      {/* How it works */}
      <section className="bg-slate-900 rounded-3xl p-6 sm:p-8 border border-slate-800 shadow-2xl space-y-6">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-slate-900 rounded-3xl p-6 border border-slate-800 space-y-3">
          ...
          <div className="bg-slate-800/80 p-3 rounded-xl border border-slate-700 text-xs font-mono space-y-1 text-slate-300">
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-slate-900 p-6 rounded-3xl border border-slate-800 shadow-2xl space-y-3">
            ...
            <div className="pt-2 border-t border-slate-800 text-sm font-semibold text-white">
      ...
      <section className="bg-gradient-to-r from-emerald-950 via-slate-900 to-slate-950 text-white rounded-3xl p-6 sm:p-8 space-y-4 border border-emerald-900/50">
