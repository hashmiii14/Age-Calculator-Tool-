  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 space-y-6 text-slate-200">
      ...
      <section className="space-y-4 text-sm leading-relaxed text-slate-300">
        ...
        <h2 className="text-xl font-bold text-white">2. Local Storage</h2>
        <p>
          We do not collect or transmit any personally identifiable information or dates of birth to external servers.
        </p>

        <h2 className="text-xl font-bold text-white">3. Third-Party Advertising & Cookies</h2>
        <p>
        ...
        <h2 className="text-xl font-bold text-white">4. Web Analytics</h2>
        <p>
